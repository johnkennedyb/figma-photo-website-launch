...
const AdminDashboard: React.FC = () => {
  ...
  if (!data) {
    return (
        <AdminSidebarLayout activePath="/admin/dashboard">
            <div className="text-red-500 p-4">No data available or failed to load.</div>
        </AdminSidebarLayout>
    );
  }

  const clientChartData = [
    { name: 'Active', value: data.userStats.activeClients },
    { name: 'Inactive', value: data.userStats.inactiveClients },
  ];

  const counselorChartData = [
    { name: 'Active', value: data.userStats.activeCounselors },
    { name: 'Inactive', value: data.userStats.inactiveCounselors },
  ];
    ...
    <div className="p-4 md:p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <UserStatusChart 
              ...
              title="Clients" 
              total={data.userStats.totalClients}
            />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <UserStatusChart 
              data={counselorChartData} 
              title="Counselors" 
              total={data.userStats.totalCounselors}
            />
          </CardContent>
        </Card>
